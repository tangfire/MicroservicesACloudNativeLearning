...
type Book struct {
	...
	// 导入其他目录下的message
	Info *author.Info `protobuf:"bytes,3,opt,name=info,proto3" json:"info,omitempty"`
	// 时间戳
...
func (x *Book) GetInfo() *author.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
const file_book_book_proto_rawDesc = "" +
	...
	"\x04info\x18\x03 \x01(\v2\f.author.InfoR\x04info\x12.\n" +
...
var file_book_book_proto_depIdxs = []int32{
	...
	2, // 1: book.Book.info:type_name -> author.Info
