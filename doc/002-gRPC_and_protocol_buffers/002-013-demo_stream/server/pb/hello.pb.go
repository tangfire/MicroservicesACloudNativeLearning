...
const file_hello_proto_rawDesc = "" +
	...
	"\rStreamService\x128\n" +
	"\rLotsOfReplies\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x000\x01\x12:\n" +
	"\x0fLotsOfGreetings\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00(\x01\x126\n" +
	"\tBidiHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00(\x010\x01B\x10Z\x0edemo_stream/pbb\x06proto3"
...
var file_hello_proto_depIdxs = []int32{
	0, // 0: pb.StreamService.LotsOfReplies:input_type -> pb.HelloRequest
	0, // 1: pb.StreamService.LotsOfGreetings:input_type -> pb.HelloRequest
	0, // 2: pb.StreamService.BidiHello:input_type -> pb.HelloRequest
	1, // 3: pb.StreamService.LotsOfReplies:output_type -> pb.HelloResponse
	1, // 4: pb.StreamService.LotsOfGreetings:output_type -> pb.HelloResponse
	1, // 5: pb.StreamService.BidiHello:output_type -> pb.HelloResponse
