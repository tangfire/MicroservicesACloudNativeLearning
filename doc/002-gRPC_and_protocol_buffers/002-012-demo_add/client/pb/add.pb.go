...
const file_add_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\x03R\x06result27\n" +
	"\vCalcService\x12(\n" +
	"\x03Add\x12\x0e.pn.AddRequest\x1a\x0f.pn.AddResponse\"\x00B\rZ\vdemo_add/pbb\x06proto3"
...
var file_add_proto_goTypes = []any{
	(*AddRequest)(nil),  // 0: pn.AddRequest
	(*AddResponse)(nil), // 1: pn.AddResponse
}
var file_add_proto_depIdxs = []int32{
	0, // 0: pn.CalcService.Add:input_type -> pn.AddRequest
	1, // 1: pn.CalcService.Add:output_type -> pn.AddResponse
